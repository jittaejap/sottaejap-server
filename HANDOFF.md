...
기준 시각: 2026-09-10 00:10 KST(PR #72 개설 · 이슈 #73 · #74 발행 반영). 상태 표는 그 순간의 스냅샷이다 — **최신은 항상 06 액션시트와 GitHub**다.
...
| 항목 | 값 |
| --- | --- |
| `main` | `82cf8fd` — PR #70(#69 HANDOFF 상태 갱신) 병합. 그 앞이 PR #68(#67 리뷰 후속 잔손질 3건 · E-112) |
| 배포 | `main` 병합 → CI 통과 → `deploy.yml`이 EC2로 자동 배포. **EC2는 프리티어**(README 배포 문단) |
| 테스트 | 전체 빌드 575건(`main` 기준), DB 통합 포함. PR #72 브랜치(`feature/#71-goal-target-date`)에서 577건. CI는 `RUN_DB_INTEGRATION_TESTS=true`로 돈다 |
| 열린 PR | **#72**(#71 목표 달성 예정일 — `V10` · `targetDate`) · **#63**(#58 XLSX 스트리밍 카운트 + 힙 명시) 둘 다 리뷰·병합 대기 |
| 열린 이슈 | **#58**(→ PR #63) · **#71**(→ PR #72) · **#73**(3-레포 연동 리허설 — §3-3을 하나로 묶었다) · **#74**(사용자 기준 금액 — client #33 후속, 정본부터) 넷이다. 앞의 둘은 PR이 서 있고 뒤의 둘은 9/9 밤에 새로 냈다. 9/9 저녁에도 한 번 정돈했다 — #60 · #66 · #57을 #67로 통합해 PR #68로 닫았고, #49는 닫아 06 R33으로만 추적한다(06 v2.52 · v2.56) |
| docs | 01 v2.40 · 04 v2.16 · 05 v2.37 · 06 v2.60 · 07 v2.16. 06이 정본 진행표다. #73 · #74는 아직 06에 R 행이 없다 |

오늘(9/9) 병합된 것: #42(#36) · #44(#20) · #45(#19) · #46(#43) · #48(#47) · #53(#51) · #54(#52) · #55(#50) · #59(#56) · #65(#64) · #62(#61) · #68(#67).
